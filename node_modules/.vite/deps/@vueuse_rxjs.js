import {
  tryOnScopeDispose
} from "./chunk-7D6PGJJY.js";
import {
  isRef,
  ref,
  watch
} from "./chunk-35NTCIV7.js";
...
// node_modules/@vueuse/rxjs/index.mjs
function from2(value, watchOptions) {
  if (isRef(value)) {
...
function fromEvent2(value, event) {
  if (isRef(value)) {
    return from2(value, { immediate: true }).pipe(filter((value2) => value2 instanceof HTMLElement), mergeMap((value2) => fromEvent(value2, event)));
  }
  return fromEvent(value, event);
}
...
function useObservable(observable2, options) {
...
export {
  from2 as from,
  fromEvent2 as fromEvent,
  toObserver,
  useObservable,
  useSubject,
  useSubscription
};
//# sourceMappingURL=@vueuse_rxjs.js.map
