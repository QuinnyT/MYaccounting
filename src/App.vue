<template>
    <div id="page1" v-show='pageshow[0] == true'>
        <div id="page1-top">
            <div id="title" class="center">敏姨爱花钱</div>
        ...
        <div id="change-page">
            <img class="close-button" src="../src/assets/close.png" alt="" @click="closeChangingPage">
            <div class="selector">
            ...
            <div class="category-list">
                <div class="category-item" v-for="(item, index) in category[changingItem.flow]" :key="index">
                    ...
                    <img @click="changeCategory" :src="'../src/assets/categoryicon/' + item.eng + '.svg'" alt="">
                    <h5>{{ item.ch }}</h5>
                </div>
                        ...
                        <table>
                            <tr>
                                ...
                                <td rowspan="2" class="del" @click="del"><img style="width: 30%;"
                                        src="../src/assets/backspace.png" alt=""></td>
                            </tr>
                            <tr>
        ...
        <div id="add-page">
            <img class="close-button" src="../src/assets/close.png" alt="" @click="closeAddingPage">
            <div class="selector">
                <button id="selectToOut">支出</button>
                <button id="selectToIn">入账</button>
                <!-- <input type="radio" id="expenditure" name="flow" value="out" />
            ...
            <div class="category-list">
                ...
                <div class="category-item" v-for="(item, index) in category[flow]" :key="index">
                    <!-- <img @click="selectCategory" :src="'./src/categoryicon/' + item.eng + '.png'" alt=""> -->
                    <img @click="selectCategory" :src="'../src/assets/categoryicon/' + item.eng + '.svg'" alt="">
                    <h5>{{ item.ch }}</h5>
                </div>
